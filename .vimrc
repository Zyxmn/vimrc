...
" Go to https://github.com/snoe/dotfiles/blob/master/home/.vim/coc-settings.json and copy over the contents to your config file via :CocConfig command
